...
<head>
    ...
    <style type="text/css">
        ...
        .signinpanel .form-control {
            <%--background: #fff url(${webRoot}/css/plugins/login/user.png) no-repeat 95% center;--%>
            color:#333;
        }
        .text-muted{
            color: #ffffff;
...
<div class="middle-box text-center loginscreen   animated fadeInDown">
    <div  class="signinpanel">
        ...
        <form class="m-t" role="form" action="/user/register">
            ...
            <p class="text-muted text-center"><small>已经有账户了？</small><a href="/user/loginView">点此登录</a>
            </p>
        </form>
    </div>
</div>
